...
/*Time to find some relation between the tables in AMBS*/
-----------------------------------------------------------------------------------------
-----------------------------------------------------------------------------------------
...
/*ALL foreign key and primary key*/
...
/*ALL foreign key and primary key (END)*/
...
SELECT FullName, P_GroupId, P_MemberId,P_LoanAccount.Id, DisbursedDate
From [AMBSZM].[dbo].[P_Member]
INNER JOIN [AMBSZM].[dbo].[P_LoanAccount]
On [AMBSZM].[dbo].[P_Member].Id = [AMBSZM].[dbo].[P_LoanAccount].P_MemberId
...
-----------------Prove of my solution (Start) ---------------------------------------
SELECT * from [AMBSZM].[dbo].[P_Member] Where FullName like '%Akash Ahmed%'
SELECT * from [AMBSZM].[dbo].[P_LoanAccount] Where P_MemberId = 90135
...
--Relation ship between P_Member and P_LoanApplication
----------------------------------------------------
SELECT * from [AMBSZM].[dbo].[P_Member]
SELECT * from [AMBSZM].[dbo].[P_LoanApplication]

--INNNER Join between P_Member and P_LoanApplication
...
---Prove of my solution ----
--Look at the ProposedDuration, PassbookNumber they should be 6,9 for below queries

SELECT * from [AMBSZM].[dbo].[P_LoanApplication] where P_MemberId = '1266885'
SELECT * from [AMBSZM].[dbo].[P_Member]  where Id = '1266885'

SELECT FullName, P_GroupId, P_MemberId, P_LoanAccountId, ProposedDuration, PassbookNumber
From [AMBSZM].[dbo].[P_Member]
INNER JOIN [AMBSZM].[dbo].[P_LoanApplication]
On [AMBSZM].[dbo].[P_Member].Id = [AMBSZM].[dbo].[P_LoanApplication].P_MemberId where P_MemberId = '1266885'
-------------------------------------------------------------------------------------------
...
--P_Member &P_MemberStatus
Select * FROM [AMBSZM].[dbo].[P_Member] 
Select * FROM [AMBSZM].[dbo].[P_MemberStatus]

--Inner join
Select P_Member.Id,P_MemberId, P_GroupId, FullName
From [AMBSZM].[dbo].[P_Member]
INNER JOIN [AMBSZM].[dbo].[P_MemberStatus]
On [AMBSZM].[dbo].[P_Member].Id = [AMBSZM].[dbo].[P_MemberStatus].P_MemberId
...
Select Sum(debit-credit) from [AMBSZM].[dbo].[A_TransactionDetails]  
